...
export const StatusBadge: React.FC<StatusBadgeProps> = ({
  ...
  const config = {
    ...
    expiring_next_month: {
      ...
      bgColor: "bg-teal-500/15 dark:bg-[rgba(38, 132, 124,0.10)]",
      textColor: "text-teal-700 dark:text-[var(--brand-500)]",
      borderColor: "border-teal-500/30 dark:border-[rgba(38, 132, 124,0.22)]",
