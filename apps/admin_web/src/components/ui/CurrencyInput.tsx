...
export const CurrencyInput = React.forwardRef<HTMLInputElement, CurrencyInputProps>(
  ({ label, labelClassName, helperText, error, value, onChange, sizeVariant = "lg", placeholder = "0", disabled, className = "", id }, ref) => {
    ...
    return (
      <div className="w-full flex flex-col gap-1.5">
        ...
        <div className="relative flex items-center w-full">
          <span className="absolute left-3.5 text-slate-500 dark:text-fg-muted font-semibold text-xs sm:text-sm pointer-events-none">Rp</span>
          <input
            ref={ref}
            id={generatedId}
            type="text"
