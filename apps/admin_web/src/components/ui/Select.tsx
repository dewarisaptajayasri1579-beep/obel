      ...
      {open &&
        ...
        createPortal(
          <div
            ...
            className="z-50 rounded-2xl bg-white/95 dark:bg-[var(--field-bg)] backdrop-blur-xl border border-slate-200/80 dark:border-[rgba(148,163,184,0.14)] shadow-2xl shadow-slate-900/10 overflow-hidden animate-in fade-in zoom-in-95 duration-150"
          >
            {searchable && (
