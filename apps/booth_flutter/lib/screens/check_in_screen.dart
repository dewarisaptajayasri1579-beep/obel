  ...
  Future<void> _submit() async {
    ...
    try {
      final defaultBoothId = _assignment != null
          ...
          : null;
      final override =
          _selectedBoothId != defaultBoothId ? _selectedBoothId : null;
              ...
              : Column(
                  ...
                  children: [
                    ...
                    const Text(
                      ...
                      style: TextStyle(color: ObbelTheme.textLight, fontSize: 13),
                    ),
                    ...
                    if (_assignment == null) ...[
                      Container(
                        ...
                        child: const Text(
                          ...
                          style: TextStyle(color: ObbelTheme.accentRed, fontWeight: FontWeight.w600),
                        ),
                      ),
                      const SizedBox(height: 12),
                      OutlinedButton(
                        onPressed: _loadingAssignment ? null : _loadAssignment,
